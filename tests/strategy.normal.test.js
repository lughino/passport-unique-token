...
describe('Strategy', function() {
  ...
  describe('handling a request with valid credentials in params', function() {
    var strategy = new Strategy(function(token, done) {
      if (token === 'sdvoihweui3498d9vhwoufhi8h') {
        return done(null, {id: '1234'}, {scope: 'read'});
      }
    ...
    before(function(done) {
      chai.passport(strategy)
        ...
        .req(function(req) {
          req.params = {};
          req.params.token = 'sdvoihweui3498d9vhwoufhi8h';
        })
        .authenticate();
    });
  ...
  describe('handling a request with valid credentials in header', function() {
    var strategy = new Strategy(function(token, done) {
      if (token === 'sdvoihweui3498d9vhwoufhi8h') {
        return done(null, {id: '1234'}, {scope: 'read'});
      }
    ...
    before(function(done) {
      chai.passport(strategy)
        ...
        .req(function(req) {
          req.headers = {};
          req.headers.token = 'sdvoihweui3498d9vhwoufhi8h';
        })
        .authenticate();
    });
