...
function Strategy(options, verify) {
    ...
    if(!verify) { throw new TypeError('Token authentication strategy requires a verify function'); }
...
Strategy.prototype.authenticate = function(req, options) {
    options = options || {};
    var self = this;
    var token = lookup(req.body, this._tokenField) || lookup(req.query, this._tokenQuery) || lookup(req.params, this._tokenParams);
    if(!token) {
